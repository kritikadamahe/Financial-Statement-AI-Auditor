...
function GradientText({
  ...
  return (
    <MotionComponent
      className={cn(
        "relative inline-flex overflow-hidden bg-white text-black dark:bg-black dark:text-white",
        className,
      )}
      {...props}
    >
      <span className="relative z-10">{children}</span>
      <span className="pointer-events-none absolute inset-0 mix-blend-lighten dark:mix-blend-darken z-20">
